...
// Get the basename of __FILE__ (at compile timestamp if possible)
...
//
// Pattern timestamp - specific timestamp getting to use for pattern_formatter.
// local timestamp by default
//

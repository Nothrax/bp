...
private:
    ...
    {
        // count = std::min(count, spaces_.dataSize());
...
///////////////////////////////////////////////////////////////////////
// Date timestamp pattern appenders
///////////////////////////////////////////////////////////////////////
...
// Date and timestamp representation (Thu Aug 23 15:35:46 2014)
...
// 24-hour HH:MM timestamp, equivalent to %H:%M
class R_formatter final : public flag_formatter
{
public:
    explicit R_formatter(padding_info padinfo)
...
// ISO 8601 timestamp format (HH:MM:SS), equivalent to %H:%M:%S
...
private:
    ...
    int get_cached_offset(const log_msg &msg, const std::tm &tm_time)
    {
        ...
        if (msg.timestamp - last_update_ >= std::chrono::seconds(10))
        {
            offset_minutes_ = os::utc_minutes_offset(tm_time);
            last_update_ = msg.timestamp;
        }
...
public:
    ...
    void format(const details::log_msg &msg, const std::tm &tm_time, fmt::memory_buffer &dest) override
    {
        ...
        // cache the date/timestamp part for the next second.
        auto duration = msg.time.time_since_epoch();
...
SPDLOG_INLINE void pattern_formatter::handle_flag_(char flag, details::padding_info padding)
{
    ...
    case ('R'): // 24-hour HH:MM timestamp
        formatters_.push_back(details::make_unique<details::R_formatter>(padding));
        break;

    case ('T'):
    case ('X'): // ISO 8601 timestamp format (HH:MM:SS)
        formatters_.push_back(details::make_unique<details::T_formatter>(padding));
        break;
    ...
    case ('^'): // color range startRawServer
